...
public class Venues {
    ...
    public final void testVenue() throws FoursquareApiException {
        ...
        assertEquals("4a7a511970c603bbd64e8eb4",
                result.getResult().getTips().getGroups()[0].getItems()[0].getId());
        assertTrue(result.getResult().getCategories()[0].getPrimary());
        assertArrayEquals(new String[] { "bakery", "baking", "breakfast", "brunch",
                "fried chicken", "pancakes", "scones", "southern" }, result.getResult().getTags());
    ...
    public final void testVenueSpecials() throws FoursquareApiException {
        ...
        assertEquals(
                "Want 20% off? Check in at RadioShack for the first time & get 20% off your qualifying purchase. Ends 6/30/11. Exclusions apply. Ask associate for details.",
                result.getResult().getSpecials().getItems()[0].getMessage());
    ...
    public final void testVenuesAdd() throws FoursquareApiException {
        ...
        Result<CompleteVenue> completeVenue = foursquareApi.venuesAdd(name, address, null, city,
                state, zip, phone, ll, primaryCategoryId);
        ...
        assertEquals("friends' checkin photos",
                completeVenue.getResult().getPhotos().getGroups()[0].getName());
    ...
    public final void testVenuesCategories() throws FoursquareApiException {
        ...
        assertEquals("https://foursquare.com/img/categories/arts_entertainment/default.png",
                result.getResult()[0].getIcon());
        ...
        assertEquals("https://foursquare.com/img/categories/arts_entertainment/arcade.png",
                result.getResult()[0].getCategories()[0].getIcon());
    ...
    public final void testVenuesSearch() throws FoursquareApiException {
        ...
        Result<VenuesSearchResult> result = foursquareApi.venuesSearch("40.7,-74", null, null,
        ...
        assertEquals(new Double(40.70443641202592), trendingGroup.getItems()[0].getLocation()
                .getLat());
        assertEquals(new Double(-74.01012361049652), trendingGroup.getItems()[0].getLocation()
                .getLng());
        assertEquals("4bf58dd8d48988d116941735",
                trendingGroup.getItems()[0].getCategories()[0].getId());
        ...
        assertEquals(new Double(40.701984159668676), nearbyGroup.getItems()[0].getLocation()
                .getLat());
        assertEquals(new Double(-73.9969539642334), nearbyGroup.getItems()[0].getLocation()
                .getLng());
        assertEquals("4bf58dd8d48988d163941735",
                nearbyGroup.getItems()[0].getCategories()[0].getId());
    ...
    public final void testVenuesSearch20110615() throws FoursquareApiException {
        ...
        Result<VenuesSearchResult> result = foursquareApi.venuesSearch("40.7,-74.0", null, null,
                null, null, null, null, null, null, null, null, null, null);
        assertEquals(new Integer(200), result.getMeta().getCode());
    ...
    public final void testVenuesProposeEdit() throws FoursquareApiException {
        FoursquareApi foursquareApi = TestUtils.getAuthenticatedFoursquareApi();
        Result<Object> result = foursquareApi.venuesProposeEdit("4de88f43d22d09215a1f73e1",
                "Apuvälineyksikkö / Moision toimipiste", "Moisiontie 11 b", null, "Mikkeli",
                "Etelä-Savo", "50520", "0443516511", "61.677701,27.272585",
    ...
    public final void testVenuesEdit() throws FoursquareApiException {
        FoursquareApi foursquareApi = TestUtils.getAuthenticatedFoursquareApi();
        Result<Object> result = foursquareApi.venuesEdit("4de88f43d22d09215a1f73e1",
                "Apuvälineyksikkö / Moision toimipiste", "Moisiontie 11 b", null, "Mikkeli",
                "Etelä-Savo", "50520", "0443516511", "61.677701,27.272585",
                "4bf58dd8d48988d104941735", null, null, null);
    ...
    public final void testVenuesExplore() throws FoursquareApiException {
        FoursquareApi foursquareApi = TestUtils.getAnonymousFoursquareApi();
        Result<Recommended> result = foursquareApi.venuesExplore("40.7,-74", null, null, null,
        ...
        assertEquals(new Long(1), result.getResult().getGroups()[0].getItems()[0].getReasons()
                .getCount());
        assertEquals("general", result.getResult().getGroups()[0].getItems()[0].getReasons()
                .getItems()[0].getType());
        assertEquals("This place is popular on foursquare.",
                result.getResult().getGroups()[0].getItems()[0].getReasons().getItems()[0]
                        .getMessage());
        assertEquals("4a9ff488f964a520b73d20e3", result.getResult().getGroups()[0].getItems()[0]
                .getVenue().getId());
        assertEquals("4abe660770c603bb50838eb4",
                result.getResult().getGroups()[0].getItems()[0].getTips()[0].getId());
    }

    @Test
    public final void testVenuesExploreWarning() throws FoursquareApiException {
        FoursquareApi foursquareApi = TestUtils.getAnonymousFoursquareApi();
        Result<Recommended> result = foursquareApi.venuesExplore("10.7,-74", null, null, null,
                null, null, null, null, null);
        assertEquals(new Integer(200), result.getMeta().getCode());
        assertEquals(
                "There aren't a lot of results near you. Try expanding the search area by tapping the settings button on the top left of the screen.",
                result.getResult().getWarning().getText());
    }
    ...
    public final void testVenuesLinks() throws FoursquareApiException {
        ...
        assertEquals(
                "http://www.nytimes.com/restaurants/1002207971611/db-bistro-moderne/details.html",
                result.getResult().getItems()[0].getUrl());
    }

    @Test
    public final void testVenuesFlag() throws FoursquareApiException {
        FoursquareApi foursquareApi = TestUtils.getAuthenticatedFoursquareApi();
        Result<Object> result = foursquareApi
                .venuesFlag("4beb18a36295c9b669478708", "closed", null);
        assertEquals(new Integer(200), result.getMeta().getCode());
    }
    ...
    public final void testVenuesTips() throws FoursquareApiException {
        ...
        assertEquals(
                "blueberry pancakes + sugar cured bacon + scrambled eggs = a plate full of goodness",
                result.getResult().getItems()[0].getText());
        ...
        assertEquals(
                "https://playfoursquare.s3.amazonaws.com/pix/APSJTPELZ5LGL0AYHGKVQEECS5QSXGCQYULHAXBLR5ZTDNS2.jpg",
                result.getResult().getItems()[10].getPhotoURL());
        assertEquals(
                "https://playfoursquare.s3.amazonaws.com/pix/APSJTPELZ5LGL0AYHGKVQEECS5QSXGCQYULHAXBLR5ZTDNS2.jpg",
                result.getResult().getItems()[10].getPhoto().getUrl());
    }
    ...
    public final void testVenuesPhotos() throws FoursquareApiException {
        FoursquareApi foursquareApi = TestUtils.getAuthenticatedFoursquareApi();
        Result<PhotoGroup> result = foursquareApi.venuesPhotos("43695300f964a5208c291fe3", "venue",
                null, null);
        ...
        assertEquals(
                "https://playfoursquare.s3.amazonaws.com/pix/ELYWFCR5XDLEKDHDCVBCIZZJFJREEQQPOF4B0Z2MPQ433HSN.jpg",
                result.getResult().getItems()[0].getUrl());
        assertEquals(new Long(4), result.getResult().getItems()[0].getSizes().getCount());
        assertEquals(new Integer(720),
                result.getResult().getItems()[0].getSizes().getItems()[0].getHeight());
        assertEquals(new Integer(537),
                result.getResult().getItems()[0].getSizes().getItems()[0].getWidth());
        assertEquals(
                "https://playfoursquare.s3.amazonaws.com/pix/ELYWFCR5XDLEKDHDCVBCIZZJFJREEQQPOF4B0Z2MPQ433HSN.jpg",
                result.getResult().getItems()[0].getSizes().getItems()[0].getUrl());
        assertEquals("foursquare for iPhone", result.getResult().getItems()[0].getSource()
                .getName());
        assertEquals("https://foursquare.com/download/#/iphone", result.getResult().getItems()[0]
                .getSource().getUrl());
